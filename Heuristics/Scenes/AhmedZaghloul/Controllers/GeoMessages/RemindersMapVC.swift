...
struct PreferencesKeys {
    ...
    static let receivedMessages = "rec"
}

class RemindersMapVC: UIViewController {
...
extension RemindersMapVC: AddGeotificationsViewControllerDelegate {
    
    func addGeotificationViewController(controller: AddGeotificationViewController, didAddCoordinate coordinate: CLLocationCoordinate2D, radius: Double, identifier: String, note: String, eventType: EventType,senderName:String) {
...
extension RemindersMapVC: CLLocationManagerDelegate {
...
extension RemindersMapVC: MKMapViewDelegate {
